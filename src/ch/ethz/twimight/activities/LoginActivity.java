...
public class LoginActivity extends Activity implements OnClickListener {
	...
	private static final String TWITTER_SCREENNAME = "twitter_screenname";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setRestartIntent(PendingIntent.getActivity(this.getBaseContext(), 0, new Intent(getIntent()), getIntent()
				.getFlags()));
		instance = this;
	...
	private class GetRequestTokenTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			OAuthProvider provider = new CommonsHttpOAuthProvider(TWITTER_REQUEST_TOKEN_URL, TWITTER_ACCESS_TOKEN_URL,
	...
	private class GetAccessTokensTask extends AsyncTask<Uri, Void, String> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			progressDialog = ProgressDialog.show(LoginActivity.this, getString(R.string.in_progress),
		...
		protected void onPostExecute(String result) {
			...
			if (success) {
				SharedPreferences.Editor edit = PreferenceManager.getDefaultSharedPreferences(LoginActivity.this)
						.edit();
	...
	static class PerformLogoutTask extends AsyncTask<Context, Void, Void> {
		...
		protected Void doInBackground(Context... params) {
			...
			TwitterSyncService.clearAllPreferences(context);
					...
					if (intent.getAction().equals(LoginActivity.LOGIN_RESULT_ACTION)) {
						...
						if (intent.hasExtra(LoginActivity.LOGIN_RESULT)) {
							...
							if (intent.getIntExtra(LoginActivity.LOGIN_RESULT, LoginActivity.LOGIN_FAILURE) == LoginActivity.LOGIN_SUCCESS) {
								...
								Toast.makeText(getBaseContext(), getString(R.string.error_login), Toast.LENGTH_SHORT)
										.show();
							}
						}
					}
